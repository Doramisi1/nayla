...
const { useSingleFileAuthState, DisconnectReason, fetchLatestBaileysVersion, generateForwardMessageContent, prepareWAMessageMedia, generateWAMessageFromContent, generateMessageID, downloadContentFromMessage, makeInMemoryStore, jidDecode, proto } = require('@adiwajshing/baileys')
const { WAConnection } = require('@adiwajshing/Baileys/src/Defaults/baileys-version.json')
 ...
 */
    ...
    */
     ...
     * @param {Object} options 
     */
    async sendLoc(jid, path, name, address, quoted, options) {
      ...
      return await this.sendMessage(jid, {
        ...
        address,
        jpegThumbnail: file
      }, MessageType.location, { contextInfo: { mentionedJid: this.parseMention(name + address) }, quoted, ...options })
    }
